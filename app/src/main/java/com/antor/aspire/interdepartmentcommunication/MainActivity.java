...
public class MainActivity extends AppCompatActivity {
    ...
    private TabsAccessorAdaptar myTabsAccessorAdaptar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTabsAccessorAdaptar = new TabsAccessorAdaptar(getSupportFragmentManager());
        myViewPager.setAdapter(myTabsAccessorAdaptar);
    ...
    private void RequestNewGroup()
    {
        ...
        groupNameField.setHint("e.g ICT 17th Batch");
